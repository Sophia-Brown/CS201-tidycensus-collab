...
edu_attainment_map <- ggplot(edu_attainment) +
  ...
  theme_void() +
  labs(title = "Percent Living Below Poverty Line by Tract (Honolulu)")
...
ggplot(edu_attainment_2019_2023, aes(x = as.numeric(year), y = estimate)) +
  geom_point(size = 3, color = "steelblue") +
  labs(
    title = "Exploring the Relationship Between Year and Poverty Rate in Honolulu County",
    x = "Year",
